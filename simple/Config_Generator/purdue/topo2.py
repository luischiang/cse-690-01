...
NUM_LGCHAIN = 3 # number of logical chain randomly added to a pair of hosts
NUM_MB = 50 # number of middlebox randomly added
...
def gen_topo(filename, output):
	...
	for sw in SW_LIST:
		...
		index = sw.index("S")
		nid = sw[index+1:]
		of.write("%s %s %d\n" % (sw, HOST_LIST[host_num], HOST2SW_RES))
		host_num = host_num + 1
