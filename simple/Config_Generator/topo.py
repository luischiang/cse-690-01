...
# > yum install graphviz python-matplotlib
...
NUM_LGCHAIN = 2 # number of logical chain randomly added to a pair of hosts
NUM_MB = 20 # number of middlebox randomly added
...
if __name__ == "__main__":
	...
	g = build_graph(PRE_TOPO + prjname)
	draw_graph(g, prjname)	
