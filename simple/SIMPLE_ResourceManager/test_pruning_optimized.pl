...
my $outfile_chains = "allchains_pruned";
...
my $prunedset = greedy_pruning_sequenceset_maxiter_priqueue2( $SequencesPerClass, $NumSequencesPerClass, $RoutesPerSequencePerClassRef, $NodeIDtoNameRef,$ClassID2VolumeRef, $SwitchResourcesRef,$MboxResourcesRef,100 );
print "Done Greedy\n";
