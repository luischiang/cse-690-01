...
main (int argc, char *argv[])
{
 ...
 time_t start, end;
  ...
  /* Set the time limit for the CPlex program to terminate */

    CPXsetdblparam (env, CPX_PARAM_TILIM, 20000);


  //  CPXsetlongparam (env, CPX_PARAM_CUTPASS, -1);
   ...
   status = CPXsolwrite(env,lp,argv[2]);
...
usage (char *progname)
{
   fprintf (stderr,"Usage: %s filename solutionfile\n", progname);
