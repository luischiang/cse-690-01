...
<CPLEXSolution version="1.2">
 <header
   problemName="tunnel_200Dynamic1366794717.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S1" index="19" slack="173"/>
  <constraint name="RuleLoad.S8" index="20" slack="181"/>
  <constraint name="RuleLoad.S2" index="21" slack="181"/>
  <constraint name="RuleLoad.S5" index="22" slack="181"/>
  <constraint name="RuleLoad.S9" index="23" slack="181"/>
  <constraint name="RuleLoad.S7" index="24" slack="181"/>
  <constraint name="RuleLoad.S3" index="25" slack="181"/>
  <constraint name="SanityCheck.1.0" index="26" slack="0.5"/>
  <constraint name="SanityCheck.1.1" index="27" slack="1"/>
  <constraint name="SanityCheck.1.2" index="28" slack="0.5"/>
  <constraint name="SanityCheck.1.3" index="29" slack="1"/>
  <constraint name="SanityCheck.1.4" index="30" slack="1"/>
  <constraint name="SanityCheck.1.5" index="31" slack="1"/>
  <constraint name="SanityCheck.1.6" index="32" slack="1"/>
  <constraint name="SanityCheck.1.7" index="33" slack="1"/>
 </linearConstraints>
 <variables>
  ...
  <variable name="a_1_7" index="15" value="1"/>
  <variable name="a_1_2" index="16" value="1"/>
  <variable name="a_1_0" index="17" value="1"/>
  <variable name="a_1_5" index="18" value="1"/>
  <variable name="a_1_1" index="19" value="1"/>
  <variable name="a_1_4" index="20" value="1"/>
  <variable name="a_1_6" index="21" value="1"/>
  <variable name="a_1_3" index="22" value="1"/>
 </variables>
</CPLEXSolution>
