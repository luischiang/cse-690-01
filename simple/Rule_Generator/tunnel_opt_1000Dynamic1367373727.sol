...
<CPLEXSolution version="1.2">
 <header
   problemName="tunnel_1000Dynamic1367373727.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S1" index="18" slack="965"/>
  <constraint name="RuleLoad.S8" index="19" slack="977"/>
  <constraint name="RuleLoad.S2" index="20" slack="975"/>
  <constraint name="RuleLoad.S5" index="21" slack="973"/>
  <constraint name="RuleLoad.S11" index="22" slack="977"/>
  <constraint name="RuleLoad.S3" index="23" slack="985"/>
  <constraint name="SanityCheck.1.0" index="24" slack="0"/>
  <constraint name="SanityCheck.1.1" index="25" slack="1"/>
  <constraint name="SanityCheck.1.2" index="26" slack="1"/>
  <constraint name="SanityCheck.1.3" index="27" slack="1"/>
  <constraint name="SanityCheck.3.0" index="28" slack="0"/>
  <constraint name="SanityCheck.3.1" index="29" slack="1"/>
  <constraint name="SanityCheck.3.2" index="30" slack="1"/>
  <constraint name="SanityCheck.3.3" index="31" slack="1"/>
  <constraint name="SanityCheck.2.0" index="32" slack="0"/>
  <constraint name="SanityCheck.2.1" index="33" slack="1"/>
  <constraint name="SanityCheck.2.2" index="34" slack="1"/>
  <constraint name="SanityCheck.2.3" index="35" slack="1"/>
 </linearConstraints>
 <variables>
