...
<CPLEXSolution version="1.2">
 <header
   problemName="tunnel_1000Dynamic1367373794.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S1" index="16" slack="981"/>
  <constraint name="RuleLoad.S8" index="17" slack="985"/>
  <constraint name="RuleLoad.S2" index="18" slack="985"/>
  <constraint name="RuleLoad.S5" index="19" slack="981"/>
  <constraint name="RuleLoad.S11" index="20" slack="985"/>
  <constraint name="SanityCheck.1.0" index="21" slack="0"/>
  <constraint name="SanityCheck.1.1" index="22" slack="1"/>
  <constraint name="SanityCheck.1.2" index="23" slack="1"/>
  <constraint name="SanityCheck.1.3" index="24" slack="1"/>
 </linearConstraints>
 <variables>
