...
<CPLEXSolution version="1.2">
 <header
   problemName="200Dynamic1366945316.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S6" index="17" slack="186"/>
  <constraint name="RuleLoad.S1" index="18" slack="184"/>
  <constraint name="RuleLoad.S11" index="19" slack="192"/>
  <constraint name="RuleLoad.S9" index="20" slack="198"/>
  <constraint name="RuleLoad.S10" index="21" slack="198"/>
  <constraint name="RuleLoad.S4" index="22" slack="190"/>
  <constraint name="RuleLoad.S8" index="23" slack="188"/>
  <constraint name="RuleLoad.S2" index="24" slack="190"/>
  <constraint name="RuleLoad.S5" index="25" slack="186"/>
  <constraint name="RuleLoad.S7" index="26" slack="194"/>
  <constraint name="RuleLoad.S3" index="27" slack="194"/>
