...
<CPLEXSolution version="1.2">
 <header
   problemName="1000Dynamic1367373277.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S6" index="17" slack="986"/>
  <constraint name="RuleLoad.S1" index="18" slack="984"/>
  <constraint name="RuleLoad.S11" index="19" slack="992"/>
  <constraint name="RuleLoad.S9" index="20" slack="998"/>
  <constraint name="RuleLoad.S10" index="21" slack="998"/>
  <constraint name="RuleLoad.S4" index="22" slack="990"/>
  <constraint name="RuleLoad.S8" index="23" slack="988"/>
  <constraint name="RuleLoad.S2" index="24" slack="990"/>
  <constraint name="RuleLoad.S5" index="25" slack="986"/>
  <constraint name="RuleLoad.S7" index="26" slack="994"/>
  <constraint name="RuleLoad.S3" index="27" slack="994"/>
  <constraint name="SanityCheck.1.0" index="28" slack="0"/>
