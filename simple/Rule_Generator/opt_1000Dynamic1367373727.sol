...
<CPLEXSolution version="1.2">
 <header
   problemName="1000Dynamic1367373727.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S6" index="18" slack="979"/>
  ...
  <constraint name="RuleLoad.S4" index="23" slack="986"/>
  <constraint name="RuleLoad.S8" index="24" slack="982"/>
  <constraint name="RuleLoad.S2" index="25" slack="986"/>
  <constraint name="RuleLoad.S5" index="26" slack="979"/>
  <constraint name="RuleLoad.S7" index="27" slack="991"/>
  <constraint name="RuleLoad.S3" index="28" slack="988"/>
