...
<CPLEXSolution version="1.2">
 <header
   problemName="tunnel_200Dynamic1364923682.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S1" index="13" slack="191"/>
  <constraint name="RuleLoad.S2" index="14" slack="188"/>
  <constraint name="RuleLoad.S5" index="15" slack="191"/>
  <constraint name="RuleLoad.S4" index="16" slack="191"/>
  <constraint name="RuleLoad.S3" index="17" slack="191"/>
