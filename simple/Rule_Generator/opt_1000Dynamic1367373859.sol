...
<CPLEXSolution version="1.2">
 <header
   problemName="1000Dynamic1367373859.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S6" index="18" slack="977"/>
  <constraint name="RuleLoad.S1" index="19" slack="976"/>
  <constraint name="RuleLoad.S11" index="20" slack="988"/>
  <constraint name="RuleLoad.S9" index="21" slack="997"/>
  <constraint name="RuleLoad.S10" index="22" slack="997"/>
  <constraint name="RuleLoad.S4" index="23" slack="980"/>
  <constraint name="RuleLoad.S8" index="24" slack="982"/>
  <constraint name="RuleLoad.S2" index="25" slack="978"/>
  <constraint name="RuleLoad.S5" index="26" slack="981"/>
  <constraint name="RuleLoad.S7" index="27" slack="991"/>
  <constraint name="RuleLoad.S3" index="28" slack="986"/>
