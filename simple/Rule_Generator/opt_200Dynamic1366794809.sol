...
<CPLEXSolution version="1.2">
 <header
   problemName="200Dynamic1366794809.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="RuleLoad.S6" index="20" slack="168"/>
  <constraint name="RuleLoad.S1" index="21" slack="176"/>
  <constraint name="RuleLoad.S9" index="22" slack="184"/>
  <constraint name="RuleLoad.S4" index="23" slack="180"/>
  <constraint name="RuleLoad.S8" index="24" slack="164"/>
  <constraint name="RuleLoad.S2" index="25" slack="176"/>
  <constraint name="RuleLoad.S5" index="26" slack="184"/>
  <constraint name="RuleLoad.S7" index="27" slack="184"/>
  <constraint name="RuleLoad.S3" index="28" slack="184"/>
  <constraint name="SanityCheck.1.0" index="29" slack="1"/>
  <constraint name="SanityCheck.1.1" index="30" slack="0"/>
  <constraint name="SanityCheck.1.2" index="31" slack="1"/>
  <constraint name="SanityCheck.1.3" index="32" slack="1"/>
  <constraint name="SanityCheck.1.4" index="33" slack="1"/>
  <constraint name="SanityCheck.1.5" index="34" slack="1"/>
  <constraint name="SanityCheck.1.6" index="35" slack="1"/>
  <constraint name="SanityCheck.1.7" index="36" slack="1"/>
  <constraint name="SanityCheck.2.0" index="37" slack="1"/>
  <constraint name="SanityCheck.2.1" index="38" slack="1"/>
  <constraint name="SanityCheck.2.2" index="39" slack="1"/>
  <constraint name="SanityCheck.2.3" index="40" slack="1"/>
  <constraint name="SanityCheck.2.4" index="41" slack="1"/>
  <constraint name="SanityCheck.2.5" index="42" slack="1"/>
  <constraint name="SanityCheck.2.6" index="43" slack="1"/>
  <constraint name="SanityCheck.2.7" index="44" slack="0"/>
 </linearConstraints>
 <variables>
  ...
  <variable name="a_1_7" index="23" value="1"/>
  <variable name="a_2_6" index="24" value="1"/>
  <variable name="a_2_3" index="25" value="1"/>
  <variable name="a_2_4" index="26" value="1"/>
  <variable name="a_2_5" index="27" value="1"/>
  <variable name="a_1_0" index="28" value="1"/>
  <variable name="a_1_5" index="29" value="1"/>
  <variable name="a_2_1" index="30" value="1"/>
  <variable name="a_1_1" index="31" value="1"/>
  <variable name="a_1_4" index="32" value="1"/>
  <variable name="a_2_2" index="33" value="1"/>
  <variable name="a_1_6" index="34" value="1"/>
  <variable name="a_2_7" index="35" value="1"/>
  <variable name="a_1_3" index="36" value="1"/>
  <variable name="a_2_0" index="37" value="1"/>
  <variable name="a_1_2" index="38" value="1"/>
 </variables>
</CPLEXSolution>
