...
<CPLEXSolution version="1.2">
 <header
   problemName="1000Dynamic1367373794.ilp"
 ...
 <linearConstraints>
  ...
  <constraint name="ProcLoadBound.M1" index="8" slack="90"/>
  <constraint name="ProcLoadBound.M5" index="9" slack="90"/>
  <constraint name="ProcLoadBound.M2" index="10" slack="90"/>
  <constraint name="MaxProcLoadBound.M11" index="11" slack="10"/>
  <constraint name="MaxProcLoadBound.M8" index="12" slack="10"/>
  ...
  <constraint name="RuleLoad.S6" index="16" slack="993"/>
  <constraint name="RuleLoad.S1" index="17" slack="992"/>
  <constraint name="RuleLoad.S11" index="18" slack="996"/>
  <constraint name="RuleLoad.S9" index="19" slack="999"/>
  <constraint name="RuleLoad.S10" index="20" slack="999"/>
  <constraint name="RuleLoad.S4" index="21" slack="996"/>
  <constraint name="RuleLoad.S8" index="22" slack="994"/>
  <constraint name="RuleLoad.S2" index="23" slack="996"/>
  <constraint name="RuleLoad.S5" index="24" slack="991"/>
  <constraint name="RuleLoad.S7" index="25" slack="997"/>
  <constraint name="RuleLoad.S3" index="26" slack="996"/>
 ...
 <variables>
  ...
  <variable name="Load.M1" index="7" value="10"/>
  <variable name="Load.M5" index="8" value="10"/>
  <variable name="Load.M2" index="9" value="10"/>
